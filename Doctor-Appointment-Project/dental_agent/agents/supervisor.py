...
from dental_agent.utils import sanitize_messages_for_supervisor
...
def supervisor_node(state: AppointmentState) -> dict:
    ...
    messages = [SystemMessage(content=SUPERVISOR_SYSTEM)] + sanitize_messages_for_supervisor(state["messages"])
